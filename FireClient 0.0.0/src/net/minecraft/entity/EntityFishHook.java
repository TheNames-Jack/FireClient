...
public class EntityFishHook extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        if(!worldObj.multiplayerWorld)
        {
            ...
            if(angler.isDead || !angler.isEntityAlive() || itemstack == null || itemstack.getItem() != Item.FISHING_ROD || getDistanceSqToEntity(angler) > 1024D)
            {
                setEntityDead();
    ...
    public int catchFish()
    {
        ...
        if(ticksCatchable > 0)
        {
            EntityItem entityitem = new EntityItem(worldObj, posX, posY, posZ, new ItemStack(Item.RAW_FISH));
