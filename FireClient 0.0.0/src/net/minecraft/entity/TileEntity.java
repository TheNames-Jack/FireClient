...
public class TileEntity
{
    ...
    static 
    {
        addMapping(net.minecraft.entity.TileEntityFurnace.class, "Furnace");
        addMapping(net.minecraft.entity.TileEntityChest.class, "Chest");
        addMapping(net.minecraft.entity.TileEntityRecordPlayer.class, "RecordPlayer");
        addMapping(net.minecraft.entity.TileEntityDispenser.class, "Trap");
        addMapping(net.minecraft.entity.TileEntitySign.class, "Sign");
        addMapping(net.minecraft.entity.TileEntityMobSpawner.class, "MobSpawner");
        addMapping(net.minecraft.entity.TileEntityNote.class, "Music");
        addMapping(net.minecraft.entity.TileEntityPiston.class, "Piston");
        addMapping(net.minecraft.entity.TileEntityBrewingStand.class, "Cauldron");
        addMapping(net.minecraft.entity.TileEntityEnchantmentTable.class, "EnchantTable");
        addMapping(net.minecraft.entity.TileEntityEndPortal.class, "Airportal");
    }
}
