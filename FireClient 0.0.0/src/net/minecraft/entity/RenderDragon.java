...
public class RenderDragon extends RenderLiving {
	...
	protected void func_40282_a(EntityEnderdragon entitydragon, float f, float f1, float f2) {
	...
	public void func_40281_a(EntityEnderdragon entitydragon, double d, double d1, double d2, float f, float f1) {
	...
	protected int func_40283_a(EntityEnderdragon entitydragon, int i, float f) {
		if(i == 1) {
			GL11.glDepthFunc(515);
		}
		if(i != 0) {
	...
	protected int shouldRenderPass(EntityLiving entityliving, int i, float f) {
		return func_40283_a((EntityEnderdragon) entityliving, i, f);
	}

	protected void renderEquippedItems(EntityLiving entityliving, float f) {
		func_40279_a((EntityEnderdragon) entityliving, f);
	}

	protected void rotateCorpse(EntityLiving entityliving, float f, float f1, float f2) {
		func_40282_a((EntityEnderdragon) entityliving, f, f1, f2);
	}

	protected void func_40270_a(EntityLiving entityliving, float f, float f1, float f2, float f3, float f4, float f5) {
		func_40280_a((EntityEnderdragon) entityliving, f, f1, f2, f3, f4, f5);
	}

	public void doRenderLiving(EntityLiving entityliving, double d, double d1, double d2, float f, float f1) {
		func_40281_a((EntityEnderdragon) entityliving, d, d1, d2, f, f1);
	}

	public void doRender(Entity entity, double d, double d1, double d2, float f, float f1) {
		func_40281_a((EntityEnderdragon) entity, d, d1, d2, f, f1);
	}
