...
import net.minecraft.block.furnace.FurnaceRecipes;
...
public class TileEntityFurnace extends TileEntity implements IInventory {
	...
	private boolean canSmelt() {
		...
		ItemStack itemstack = FurnaceRecipes.smelting().getSmeltingResult(furnaceItemStacks[0].getItem().id);
		if(itemstack == null) {
			return false;
		}
	...
	private int getItemBurnTime(ItemStack itemstack) {
		...
		return i != Item.BLAZE_ROD.id ? 0 : 2400;
	}
