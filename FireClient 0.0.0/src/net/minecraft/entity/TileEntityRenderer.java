...
public class TileEntityRenderer
{
    ...
    private TileEntityRenderer()
    {
        ...
        specialRendererMap.put(net.minecraft.entity.TileEntitySign.class, new TileEntitySignRenderer());
        specialRendererMap.put(net.minecraft.entity.TileEntityMobSpawner.class, new TileEntityMobSpawnerRenderer());
        specialRendererMap.put(net.minecraft.entity.TileEntityPiston.class, new TileEntityRendererPiston());
        specialRendererMap.put(net.minecraft.entity.TileEntityChest.class, new TileEntityChestRenderer());
        specialRendererMap.put(net.minecraft.entity.TileEntityEnchantmentTable.class, new RenderEnchantmentTable());
        specialRendererMap.put(net.minecraft.entity.TileEntityEndPortal.class, new RenderEndPortal());
    ...
    public TileEntitySpecialRenderer getSpecialRendererForClass(Class class1)
    {
        ...
        if(tileentityspecialrenderer == null && class1 != (net.minecraft.entity.TileEntity.class))
        {
