...
public class EntityEnderdragon extends EntityDragonBase {
	...
	public void onLivingUpdate() {
		...
		if(!worldObj.multiplayerWorld && maxHurtTime == 0) {
			...
			attackEntitiesInList(worldObj.getEntitiesWithinAABBExcludingEntity(this, field_40177_ap.boundingBox.expand(1.0D, 1.0D, 1.0D)));
		}
	...
	private void updateDragonEnderCrystal() {
		...
		if(rand.nextInt(10) == 0) {
			float f = 32F;
			List list = worldObj.getEntitiesWithinAABB(net.minecraft.entity.EntityEnderCrystal.class, boundingBox.expand(f, f, f));
