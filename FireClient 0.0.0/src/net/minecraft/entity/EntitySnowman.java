...
public class EntitySnowman extends EntitySnowmanBase
{
    ...
    public void onLivingUpdate()
    {
        ...
        {
            List list = worldObj.getEntitiesWithinAABB(net.minecraft.entity.EntityMob.class, AxisAlignedBB.getBoundingBoxFromPool(posX, posY, posZ, posX + 1.0D, posY + 1.0D, posZ + 1.0D).expand(16D, 4D, 16D));
            if(!list.isEmpty())
            {
