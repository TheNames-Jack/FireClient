...
public class AchievementMap
{
    ...
    private AchievementMap()
    {
        ...
        try
        {
            BufferedReader bufferedreader = new BufferedReader(new InputStreamReader((net.minecraft.achievement.AchievementMap.class).getResourceAsStream("/achievement/map.txt")));
            String s;
