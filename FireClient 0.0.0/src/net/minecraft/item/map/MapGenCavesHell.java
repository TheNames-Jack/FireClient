...
public class MapGenCavesHell extends MapGenBase
{
            ...
            double d3)
    {
        ...
        for(; k < l; k++)
        {
            ...
            if(l1 > worldObj.worldYMax - 8)
            {
                l1 = worldObj.worldYMax - 8;
            }
            if(d10 < 0)
            {
                d10 = 0;
            ...
            for(int j2 = d8; !flag2 && j2 < k1; j2++)
            {
                for(int l2 = d10; !flag2 && l2 < i2; l2++)
                {
                    ...
                    {
                        int j3 = (j2 * 16 + l2) * worldObj.worldYMax + i3;
                        if(i3 < 0 || i3 >= worldObj.worldYMax)
                        {
                            continue;
                        }
            ...
            for(int k2 = d8; k2 < k1; k2++)
            {
                ...
                for(int k3 = d10; k3 < i2; k3++)
                {
                    ...
                    int l3 = (k2 * 16 + k3) * worldObj.worldYMax + l1;
    ...
    protected void recursiveGenerate(World world, int i, int j, int k, int l, byte abyte0[])
    {
        ...
        for(int j1 = 0; j1 < i1; j1++)
        {
            ...
            double d1 = rand.nextInt(world.worldYMax);
