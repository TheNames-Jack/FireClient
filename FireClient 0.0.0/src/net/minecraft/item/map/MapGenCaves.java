...
public class MapGenCaves extends MapGenBase
{
            ...
            int k, int i1, double d3)
    {
        ...
        for(; k < i1; k++)
        {
            ...
            if(i2 > worldObj.worldYMax - 8)
            {
                i2 = worldObj.worldYMax - 8;
            }
            if(d10 < 0)
            {
                d10 = 0;
            ...
            for(int k2 = d8; !flag2 && k2 < l1; k2++)
            {
                for(int i3 = d10; !flag2 && i3 < j2; i3++)
                {
                    ...
                    {
                        int k3 = (k2 * 16 + i3) * worldObj.worldYMax + j3;
                        if(j3 < 0 || j3 >= worldObj.worldYMax)
                        {
                            continue;
                        }
...
label0:
                for(int l3 = d10; l3 < j2; l3++)
                {
                    ...
                    int i4 = (l2 * 16 + l3) * worldObj.worldYMax + i2;
                    boolean flag3 = false;
    ...
    protected void recursiveGenerate(World world, int i, int j, int k, int l, byte abyte0[])
    {
        ...
        for(int j1 = 0; j1 < i1; j1++)
        {
            ...
            double d1 = rand.nextInt(rand.nextInt(world.worldYMax - 8) + 8);
