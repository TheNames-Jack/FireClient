...
import net.minecraft.world.structure.ComponentStrongholdStairs2;
...
public class MapGenStronghold extends MapGenStructure {
	...
	protected StructureStart getStructureStart(int i, int j) {
		...
		for(structurestrongholdstart = new StructureStrongholdStart(worldObj, rand, i, j); structurestrongholdstart.func_40560_b().isEmpty()
				|| ((ComponentStrongholdStairs2) structurestrongholdstart.func_40560_b().get(0)).field_40009_b == null; structurestrongholdstart = new StructureStrongholdStart(worldObj, rand, i, j)) {
		}
