...
public class ItemMap extends ItemMapBase {
	...
	public static MapData getMPMapData(short word0, World world) {
		...
		MapData mapdata = (MapData) world.loadItemData(net.minecraft.item.map.MapData.class, (new StringBuilder()).append("map_").append(word0).toString());
		if(mapdata == null) {
	...
	public MapData getMapData(ItemStack itemstack, World world) {
		...
		MapData mapdata = (MapData) world.loadItemData(net.minecraft.item.map.MapData.class, (new StringBuilder()).append("map_").append(itemstack.getItemDamage()).toString());
		if(mapdata == null) {
