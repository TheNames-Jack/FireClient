...
public class GuiMainMenu extends GuiScreen {
	...
	private int logoWidth = 256;
	private int logoHeight = 51;
	...
	private void func_35355_b(int i, int j, float f) {
		...
		for(int l = 0; l < k * k; l++) {
			...
			for(int i1 = 0; i1 < 6; i1++) {
				...
				GL11.glBindTexture(3553 /* GL_TEXTURE_2D */, mc.renderEngine.getTexture((new StringBuilder()).append("/title/bg/spawn").append(i1).append(".png").toString()));
	...
	public void drawScreen(int i, int j, float f) {
		...
		GL11.glBindTexture(3553 /* GL_TEXTURE_2D */, mc.renderEngine.getTexture("/title/firehacklogo.png"));
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
		drawTexturedModalRect(k + 12, byte0 + 0, 0, 0, logoWidth, logoHeight);
		...
		GL11.glPopMatrix();
		drawString(fontRenderer, IINFO.name + " " + IINFO.version, 2, height - 10, 0xffffff);
