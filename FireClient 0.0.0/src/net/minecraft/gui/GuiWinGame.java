...
public class GuiWinGame extends GuiScreen {
	...
	private void func_41041_e() {
		if(mc.theWorld.multiplayerWorld) {
			...
			entityclientplayermp.sendQueue.addToSendQueue(new Packet9Respawn((byte) entityclientplayermp.dimension, (byte) mc.theWorld.difficultySetting, mc.theWorld.getWorldSeed(), mc.theWorld.worldYMax, 0));
		}else {
	...
	public void initGui() {
		...
		try {
			...
			BufferedReader bufferedreader = new BufferedReader(new InputStreamReader((net.minecraft.gui.GuiWinGame.class).getResourceAsStream("/title/win.txt"), Charset.forName("UTF-8")));
			...
			bufferedreader = new BufferedReader(new InputStreamReader((net.minecraft.gui.GuiWinGame.class).getResourceAsStream("/title/credits.txt"), Charset.forName("UTF-8")));
			while((s = bufferedreader.readLine()) != null) {
