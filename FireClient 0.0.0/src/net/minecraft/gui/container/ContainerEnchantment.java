...
import net.minecraft.block.craftingtable.ICrafting;
import net.minecraft.block.enchantmenttable.EnchantmentData;
...
import net.minecraft.util.SlotEnchantment;
import net.minecraft.util.SlotEnchantmentTable;
