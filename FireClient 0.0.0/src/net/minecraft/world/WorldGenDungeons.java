...
import net.minecraft.entity.TileEntityChest;
import net.minecraft.entity.TileEntityMobSpawner;
...
label0:
    ...
    private ItemStack pickCheckLootItem(Random random)
    {
        ...
        if(i == 6)
        {
            return new ItemStack(Item.EMPTY_BUCKET);
        }
        if(i == 7 && random.nextInt(100) == 0)
        {
            return new ItemStack(Item.GOLD_APPLE);
        }
        ...
        {
            return new ItemStack(Item.itemsList[Item.DISC_13.id + random.nextInt(2)]);
        }
        if(i == 10)
        {
