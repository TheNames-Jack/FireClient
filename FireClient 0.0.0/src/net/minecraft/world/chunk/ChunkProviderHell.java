...
import net.minecraft.item.map.MapGenBase;
import net.minecraft.item.map.MapGenCavesHell;
import net.minecraft.item.map.MapGenNetherBridge;
    ...
    implements IChunkProvider
{
    ...
    public void generateNetherTerrain(int i, int j, byte abyte0[])
    {
        ...
        for(int j1 = 0; j1 < byte0; j1++)
        {
            ...
            {
                for(int l1 = 0; l1 < worldObj.worldYMax / 8; l1++)
                {
                    double d = 0.125D;
                    ...
                    for(int i2 = 0; i2 < 8; i2++)
                    {
                        ...
                        {
                            int k2 = j2 + j1 * 4 << worldObj.chunkXZCoordinateShift | 0 + k1 * 4 << worldObj.worldYBits | l1 * 8 + i2;
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j)
    {
        ...
        for(int i1 = 0; i1 < 8; i1++)
        {
            ...
            int i3 = hellRNG.nextInt(worldObj.worldYMax - 8) + 4;
        ...
        for(int l1 = 0; l1 < j1; l1++)
        {
            ...
            int l4 = hellRNG.nextInt(worldObj.worldYMax - 8) + 4;
        ...
        for(int i2 = 0; i2 < j1; i2++)
        {
            ...
            int i5 = hellRNG.nextInt(worldObj.worldYMax - 8) + 4;
        ...
        for(int j2 = 0; j2 < 10; j2++)
        {
            ...
            int j5 = hellRNG.nextInt(worldObj.worldYMax);
        ...
        if(hellRNG.nextInt(1) == 0)
        {
            ...
            int i4 = hellRNG.nextInt(worldObj.worldYMax);
        ...
        if(hellRNG.nextInt(1) == 0)
        {
            ...
            int j4 = hellRNG.nextInt(worldObj.worldYMax);
