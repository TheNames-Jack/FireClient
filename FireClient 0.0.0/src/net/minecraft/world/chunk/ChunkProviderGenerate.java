...
import net.minecraft.item.map.MapGenCaves;
import net.minecraft.item.map.MapGenMineshaft;
import net.minecraft.item.map.MapGenRavine;
import net.minecraft.item.map.MapGenStronghold;
...
import net.minecraft.world.WorldGenLakes;
            ...
            for(int i2 = 0; i2 < byte0; i2++)
            {
                for(int j2 = 0; j2 < k; j2++)
                {
                    ...
                    for(int k2 = 0; k2 < 8; k2++)
                    {
                        ...
                        {
                            int i3 = l2 + l1 * 4 << worldObj.chunkXZCoordinateShift | 0 + i2 * 4 << worldObj.worldYBits | j2 * 8 + k2;
