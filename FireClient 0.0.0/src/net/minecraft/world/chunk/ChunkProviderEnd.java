    ...
    implements IChunkProvider
{
    ...
    public void func_40380_a(int i, int j, byte abyte0[], BiomeGenBase abiomegenbase[])
    {
        byte byte0 = 2;
        int k = byte0 + 1;
        int l = field_40392_m.worldYMax / 4 + 1;
        int i1 = byte0 + 1;
        ...
        for(int j1 = 0; j1 < byte0; j1++)
        {
            ...
            {
                for(int l1 = 0; l1 < field_40392_m.worldYMax / 4; l1++)
                {
                    double d = 0.25D;
                    ...
                    for(int i2 = 0; i2 < 4; i2++)
                    {
                        ...
                        {
                            int k2 = j2 + j1 * 8 << field_40392_m.chunkXZCoordinateShift | 0 + k1 * 8 << field_40392_m.worldYBits | l1 * 4 + i2;
                            int l2 = 1 << field_40392_m.worldYBits;
                            double d14 = 0.125D;
                            double d15 = d10;
    ...
    public Chunk provideChunk(int i, int j)
    {
        ...
        byte abyte0[] = new byte[16 * field_40392_m.worldYMax * 16];
