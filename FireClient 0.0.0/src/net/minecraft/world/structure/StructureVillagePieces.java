...
public class StructureVillagePieces {
	...
	public static ArrayList getStructureVillageWeightedPieceList(Random random, int i) {
		...
		arraylist.add(new StructureVillagePieceWeight(net.minecraft.world.structure.ComponentVillageHouse4_Garden.class, 4, MathHelper.getRandomIntegerInRange(random, 2 + i, 4 + i * 2)));
		arraylist.add(new StructureVillagePieceWeight(net.minecraft.world.structure.ComponentVillageChurch.class, 20, MathHelper.getRandomIntegerInRange(random, 0 + i, 1 + i)));
		arraylist.add(new StructureVillagePieceWeight(net.minecraft.world.structure.ComponentVillageHouse1.class, 20, MathHelper.getRandomIntegerInRange(random, 0 + i, 2 + i)));
		arraylist.add(new StructureVillagePieceWeight(net.minecraft.world.structure.ComponentVillageWoodHut.class, 3, MathHelper.getRandomIntegerInRange(random, 2 + i, 5 + i * 3)));
		arraylist.add(new StructureVillagePieceWeight(net.minecraft.world.structure.ComponentVillageHall.class, 15, MathHelper.getRandomIntegerInRange(random, 0 + i, 2 + i)));
		arraylist.add(new StructureVillagePieceWeight(net.minecraft.world.structure.ComponentVillageField.class, 3, MathHelper.getRandomIntegerInRange(random, 1 + i, 4 + i)));
		arraylist.add(new StructureVillagePieceWeight(net.minecraft.world.structure.ComponentVillageField2.class, 3, MathHelper.getRandomIntegerInRange(random, 2 + i, 4 + i * 2)));
		arraylist.add(new StructureVillagePieceWeight(net.minecraft.world.structure.ComponentVillageHouse2.class, 15, MathHelper.getRandomIntegerInRange(random, 0, 1 + i)));
		arraylist.add(new StructureVillagePieceWeight(net.minecraft.world.structure.ComponentVillageHouse3.class, 8, MathHelper.getRandomIntegerInRange(random, 0 + i, 3 + i * 2)));
	...
	private static ComponentVillage getVillageComponentFromWeightedPiece(StructureVillagePieceWeight structurevillagepieceweight, List list, Random random, int i, int j, int k, int l, int i1) {
		...
		Object obj = null;
		if(class1 == (net.minecraft.world.structure.ComponentVillageHouse4_Garden.class)) {
			obj = ComponentVillageHouse4_Garden.func_35082_a(list, random, i, j, k, l, i1);
		}else if(class1 == (net.minecraft.world.structure.ComponentVillageChurch.class)) {
			obj = ComponentVillageChurch.func_35097_a(list, random, i, j, k, l, i1);
		}else if(class1 == (net.minecraft.world.structure.ComponentVillageHouse1.class)) {
			obj = ComponentVillageHouse1.func_35095_a(list, random, i, j, k, l, i1);
		}else if(class1 == (net.minecraft.world.structure.ComponentVillageWoodHut.class)) {
			obj = ComponentVillageWoodHut.func_35091_a(list, random, i, j, k, l, i1);
		}else if(class1 == (net.minecraft.world.structure.ComponentVillageHall.class)) {
			obj = ComponentVillageHall.func_35078_a(list, random, i, j, k, l, i1);
		}else if(class1 == (net.minecraft.world.structure.ComponentVillageField.class)) {
			obj = ComponentVillageField.func_35080_a(list, random, i, j, k, l, i1);
		}else if(class1 == (net.minecraft.world.structure.ComponentVillageField2.class)) {
			obj = ComponentVillageField2.func_35089_a(list, random, i, j, k, l, i1);
		}else if(class1 == (net.minecraft.world.structure.ComponentVillageHouse2.class)) {
			obj = ComponentVillageHouse2.func_35085_a(list, random, i, j, k, l, i1);
		}else if(class1 == (net.minecraft.world.structure.ComponentVillageHouse3.class)) {
	...
	public static StructureComponent getNextStructureComponent(ComponentVillageStartPiece componentvillagestartpiece, List list, Random random, int i, int j, int k, int l, int i1) {
		return getNextVillageStructureComponent(componentvillagestartpiece, list, random, i, j, k, l, i1);
	}

	public static StructureComponent getNextStructureComponentVillagePath(ComponentVillageStartPiece componentvillagestartpiece, List list, Random random, int i, int j, int k, int l, int i1) {
