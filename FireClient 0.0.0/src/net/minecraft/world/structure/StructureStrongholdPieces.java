...
public class StructureStrongholdPieces {
	...
	private static ComponentStronghold getStrongholdComponentFromWeightedPiece(Class class1, List list, Random random, int i, int j, int k, int l, int i1) {
		Object obj = null;
		if(class1 == (net.minecraft.world.structure.ComponentStrongholdStraight.class)) {
			obj = ComponentStrongholdStraight.func_35047_a(list, random, i, j, k, l, i1);
		}else if(class1 == (net.minecraft.world.structure.ComponentStrongholdPrison.class)) {
			obj = ComponentStrongholdPrison.func_35063_a(list, random, i, j, k, l, i1);
		}else if(class1 == (net.minecraft.world.structure.ComponentStrongholdLeftTurn.class)) {
			obj = ComponentStrongholdLeftTurn.func_35045_a(list, random, i, j, k, l, i1);
		}else if(class1 == (net.minecraft.world.structure.ComponentStrongholdRightTurn.class)) {
			obj = ComponentStrongholdRightTurn.func_35045_a(list, random, i, j, k, l, i1);
		}else if(class1 == (net.minecraft.world.structure.ComponentStrongholdRoomCrossing.class)) {
			obj = ComponentStrongholdRoomCrossing.func_35059_a(list, random, i, j, k, l, i1);
		}else if(class1 == (net.minecraft.world.structure.ComponentStrongholdStairsStraight.class)) {
			obj = ComponentStrongholdStairsStraight.func_35053_a(list, random, i, j, k, l, i1);
		}else if(class1 == (net.minecraft.world.structure.ComponentStrongholdStairs.class)) {
			obj = ComponentStrongholdStairs.getStrongholdStairsComponent(list, random, i, j, k, l, i1);
		}else if(class1 == (net.minecraft.world.structure.ComponentStrongholdCrossing.class)) {
			obj = ComponentStrongholdCrossing.func_35039_a(list, random, i, j, k, l, i1);
		}else if(class1 == (net.minecraft.world.structure.ComponentStrongholdChestCorridor.class)) {
			obj = ComponentStrongholdChestCorridor.func_40010_a(list, random, i, j, k, l, i1);
		}else if(class1 == (net.minecraft.world.structure.ComponentStrongholdLibrary.class)) {
			obj = ComponentStrongholdLibrary.func_35055_a(list, random, i, j, k, l, i1);
		}else if(class1 == (net.minecraft.world.structure.ComponentStrongholdPortalRoom.class)) {
	...
	public static StructureComponent func_35850_a(ComponentStrongholdStairs2 componentstrongholdstairs2, List list, Random random, int i, int j, int k, int l, int i1) {
		return func_35848_c(componentstrongholdstairs2, list, random, i, j, k, l, i1);
	}

	public static Class func_40751_a(Class class1) {
	...
	static {
		pieceWeightArray = (new StructureStrongholdPieceWeight[]{
				new StructureStrongholdPieceWeight(net.minecraft.world.structure.ComponentStrongholdStraight.class, 40, 0), new StructureStrongholdPieceWeight(net.minecraft.world.structure.ComponentStrongholdPrison.class, 5, 5),
				new StructureStrongholdPieceWeight(net.minecraft.world.structure.ComponentStrongholdLeftTurn.class, 20, 0), new StructureStrongholdPieceWeight(net.minecraft.world.structure.ComponentStrongholdRightTurn.class, 20, 0),
				new StructureStrongholdPieceWeight(net.minecraft.world.structure.ComponentStrongholdRoomCrossing.class, 10, 6), new StructureStrongholdPieceWeight(net.minecraft.world.structure.ComponentStrongholdStairsStraight.class, 5, 5),
				new StructureStrongholdPieceWeight(net.minecraft.world.structure.ComponentStrongholdStairs.class, 5, 5), new StructureStrongholdPieceWeight(net.minecraft.world.structure.ComponentStrongholdCrossing.class, 5, 4),
				new StructureStrongholdPieceWeight(net.minecraft.world.structure.ComponentStrongholdChestCorridor.class, 5, 4), new StructureStrongholdPieceWeight2(net.minecraft.world.structure.ComponentStrongholdLibrary.class, 10, 2),
				new StructureStrongholdPieceWeight3(net.minecraft.world.structure.ComponentStrongholdPortalRoom.class, 20, 1)
		});
	}
}
