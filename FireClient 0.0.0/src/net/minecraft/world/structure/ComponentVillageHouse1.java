...
public class ComponentVillageHouse1 extends ComponentVillage
{
    ...
    public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        ...
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 4, 2, 0, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 5, 2, 0, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 6, 2, 0, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 4, 3, 0, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 5, 3, 0, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 6, 3, 0, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 0, 2, 2, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 0, 2, 3, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 0, 3, 2, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 0, 3, 3, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 8, 2, 2, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 8, 2, 3, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 8, 3, 2, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 8, 3, 3, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 2, 2, 5, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 3, 2, 5, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 5, 2, 5, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 6, 2, 5, structureboundingbox);
