...
public class ComponentVillageChurch extends ComponentVillage
{
    ...
    public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        ...
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 4, 3, 2, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 0, 6, 2, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 0, 7, 2, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 4, 6, 2, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 4, 7, 2, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 2, 6, 0, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 2, 7, 0, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 2, 6, 4, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 2, 7, 4, structureboundingbox);
