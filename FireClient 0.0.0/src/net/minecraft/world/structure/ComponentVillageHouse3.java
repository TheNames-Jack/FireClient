...
public class ComponentVillageHouse3 extends ComponentVillage
{
    ...
    public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        ...
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 8, 2, 7, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 8, 2, 8, structureboundingbox);
        ...
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 2, 2, 7, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 2, 2, 8, structureboundingbox);
        ...
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 5, 4, 10, structureboundingbox);
