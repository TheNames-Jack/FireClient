...
public class ComponentVillageHouse2 extends ComponentVillage
{
    ...
    public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        ...
        placeBlockAtCurrentPosition(world, Block.IRON_BARS.blockID, 0, 9, 2, 5, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.IRON_BARS.blockID, 0, 9, 2, 4, structureboundingbox);
        ...
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 0, 2, 4, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 2, 2, 6, structureboundingbox);
        placeBlockAtCurrentPosition(world, Block.GLASS_PANE.blockID, 0, 4, 2, 6, structureboundingbox);
