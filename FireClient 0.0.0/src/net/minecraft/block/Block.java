...
import net.minecraft.block.craftingtable.BlockCraftingTable;
import net.minecraft.block.enchantmenttable.BlockEnchantmentTable;
import net.minecraft.block.enchantmenttable.EnchantmentHelper;
import net.minecraft.block.furnace.BlockFurnace;
...
import net.minecraft.util.EnumMobType;
import net.minecraft.util.MovingObjectPosition;
import net.minecraft.util.StatCollector;
import net.minecraft.util.StatList;
import net.minecraft.util.StepSound;
import net.minecraft.util.StepSoundSand;
import net.minecraft.util.StepSoundStone;
...
public class Block {
	...
	public static final Block CLAY_BLOCK;
	...
	public static final Block ENDER_DRAGON_EGG;
	...
	public Block setTickOnLoad(boolean flag) {
	...
	public ItemStack func_41049_c_(int i) {
		int j = 0;
	...
	static {
		...
		TORCH = (new BlockTorch(50, 80)).setHardness(0.0F).setLightValue(0.9375F).setStepSound(soundWoodFootstep).setBlockName("torch").setRequiresSelfNotify();
		...
		workbench = (new BlockCraftingTable(58)).setHardness(2.5F).setStepSound(soundWoodFootstep).setBlockName("workbench");
		...
		signPost = (new BlockSign(63, net.minecraft.entity.TileEntitySign.class, true)).setHardness(1.0F).setStepSound(soundWoodFootstep).setBlockName("sign").disableStats().setRequiresSelfNotify();
		...
		signWall = (new BlockSign(68, net.minecraft.entity.TileEntitySign.class, false)).setHardness(1.0F).setStepSound(soundWoodFootstep).setBlockName("sign").disableStats().setRequiresSelfNotify();
		...
		SNOW_BLOCK = (new BlockSnowBlock(80, 66)).setHardness(0.2F).setStepSound(soundClothFootstep).setBlockName("snow");
		cactus = (new BlockCactus(81, 70)).setHardness(0.4F).setStepSound(soundClothFootstep).setBlockName("cactus");
		CLAY_BLOCK = (new BlockClay(82, 72)).setHardness(0.6F).setStepSound(soundGravelFootstep).setBlockName("clay");
		SUGAR_CANE = (new BlockReed(83, 73)).setHardness(0.0F).setStepSound(soundGrassFootstep).setBlockName("reeds").disableStats();
		...
		SOUL_SAND = (new BlockSoulSand(88, 104)).setHardness(0.5F).setStepSound(soundSandFootstep).setBlockName("hellsand");
		...
		IRON_BARS = (new BlockPane(101, 85, 85, Material.iron, true)).setHardness(5F).setResistance(10F).setStepSound(soundMetalFootstep).setBlockName("fenceIron");
		GLASS_PANE = (new BlockPane(102, 49, 148, Material.glass, false)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("thinGlass");
		...
		LILY_PAD = (new BlockLilyPad(111, 76)).setHardness(0.0F).setStepSound(soundGrassFootstep).setBlockName("waterlily");
		...
		NETHER_WART = (new BlockNetherStalk(115)).setBlockName("netherStalk").setRequiresSelfNotify();
		...
		END_STONE = (new Block(121, 175, Material.rock)).setHardness(3F).setResistance(15F).setStepSound(soundStoneFootstep).setBlockName("whiteStone");
		ENDER_DRAGON_EGG = (new BlockDragonEgg(122, 167)).setHardness(3F).setResistance(15F).setStepSound(soundStoneFootstep).setLightValue(0.125F).setBlockName("dragonEgg");
		...
		Item.itemsList[LILY_PAD.blockID] = new ItemLilyPad(LILY_PAD.blockID - 256);
