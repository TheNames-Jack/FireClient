...
public enum EnumArmorMaterial {
	CLOTH("CLOTH", 0, 5, new int[]{
			1, 3, 2, 1
	}, 15), IRON("CHAIN", 1, 15, new int[]{
			2, 5, 4, 1
	}, 12), CHAIN("IRON", 2, 15, new int[]{
			2, 6, 5, 2
	}, 9), GOLD("GOLD", 3, 7, new int[]{
			2, 5, 3, 1
	}, 25), DIAMOND("DIAMOND", 4, 33, new int[]{
			3, 8, 6, 3
	}, 10), ELYTRA("ELYTRA", 5, 0, new int[]{
			0, 0, 0, 0
	}, 0);
	...
	static {
		allArmorMaterials = (new EnumArmorMaterial[]{
				CLOTH, CHAIN, IRON, GOLD, DIAMOND, ELYTRA
		});
	}
}