...
public class StringTranslate
{
    ...
    private StringTranslate()
    {
        ...
        try
        {
            translateTable.load((net.minecraft.util.StringTranslate.class).getResourceAsStream("/lang/en_US.lang"));
            translateTable.load((net.minecraft.util.StringTranslate.class).getResourceAsStream("/lang/stats_US.lang"));
        }
