...
public class SaveConverterMcRegion extends SaveFormatOld {
	...
	public boolean convertMapFormat(String s, IProgressUpdate iprogressupdate) {
		...
		getNBTTagCompoundWithPlayers(file, arraylist, arraylist1);
		if(file1.exists()) {
			getNBTTagCompoundWithPlayers(file1, arraylist2, arraylist3);
		}
		if(file2.exists()) {
			getNBTTagCompoundWithPlayers(file2, arraylist4, arraylist5);
		}
		...
		setSpawnPosition(file, arraylist, 0, i, iprogressupdate);
		setSpawnPosition(file1, arraylist2, arraylist.size(), i, iprogressupdate);
		setSpawnPosition(file2, arraylist4, arraylist.size() + arraylist2.size(), i, iprogressupdate);
		WorldInfo worldinfo = getWorldInfo(s);
	...
	private void getNBTTagCompoundWithPlayers(File file, ArrayList arraylist, ArrayList arraylist1) {
	...
	private void setSpawnPosition(File file, ArrayList arraylist, int i, int j, IProgressUpdate iprogressupdate) {
