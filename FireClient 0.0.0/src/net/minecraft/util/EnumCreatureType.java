...
{
    monster("monster", 0, net.minecraft.entity.IMob.class, 70, Material.air, false),
    creature("creature", 1, net.minecraft.entity.EntityAnimal.class, 15, Material.air, true),
    waterCreature("waterCreature", 2, net.minecraft.entity.EntityWaterMob.class, 5, Material.water, true);
/*
