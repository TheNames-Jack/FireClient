...
import net.minecraft.entity.RenderBlocks;
import net.minecraft.entity.RenderEngine;
import net.minecraft.entity.RenderGlobal;
import net.minecraft.entity.RenderManager;
...
import net.minecraft.gui.GuiConnecting;
...
import net.minecraft.gui.GuiMainMenu;
import net.minecraft.gui.GuiScreen;
import net.minecraft.gui.GuiSleepMP;
import net.minecraft.gui.GuiUnused;
import net.minecraft.item.Item;
import net.minecraft.item.ItemRenderer;
import net.minecraft.item.ItemStack;
import net.minecraft.model.ModelBiped;
import net.minecraft.util.ColorizerFoliage;
import net.minecraft.util.ColorizerGrass;
import net.minecraft.util.ColorizerWater;
import net.minecraft.util.EffectRenderer;
import net.minecraft.util.EnumMovingObjectType;
import net.minecraft.util.EnumOS2;
import net.minecraft.util.EnumOSMappingHelper;
...
import net.minecraft.util.ProfilerResult;
import net.minecraft.util.SaveConverterMcRegion;
import net.minecraft.util.ScaledResolution;
import net.minecraft.util.ScreenShotHelper;
import net.minecraft.util.Session;
import net.minecraft.util.SoundManager;
import net.minecraft.util.StatFileWriter;
import net.minecraft.util.StatList;
import net.minecraft.util.StatStringFormatKeyInv;
import net.minecraft.util.Teleporter;
import net.minecraft.util.Tessellator;
import net.minecraft.util.TextureCompassFX;
import net.minecraft.util.TextureFlamesFX;
import net.minecraft.util.TextureLavaFX;
import net.minecraft.util.TextureLavaFlowFX;
import net.minecraft.util.TexturePackList;
import net.minecraft.util.TexturePortalFX;
import net.minecraft.util.TextureWatchFX;
import net.minecraft.util.TextureWaterFX;
import net.minecraft.util.TextureWaterFlowFX;
import net.minecraft.util.ThreadCheckHasPaid;
...
public abstract class Minecraft implements Runnable {
	...
	public void displayGuiScreen(GuiScreen guiscreen) {
		...
		if(guiscreen instanceof GuiMainMenu) {
			gameSettings.showDebugInfoLess = false;
	...
	private void updateGame() {
		...
		Profiler.endSection();
		if(gameSettings.showDebugInfoMore) {
	...
	private void func_40003_b(int i) {
		...
		if(i == 0) {
			...
			if(--i < list.size() && !((ProfilerResult) list.get(i)).name.equals("unspecified")) {
				...
				field_40006_ak += ((ProfilerResult) list.get(i)).name;
			}
		}
	}

	private void displayDebugInfo(long l) {
		List list = Profiler.getProfilingData(field_40006_ak);
		...
		for(int k3 = 0; k3 < list.size(); k3++) {
			...
			fontRenderer.drawStringWithShadow(s1 = (new StringBuilder()).append(decimalformat.format(profilerresult2.sectionPercentage)).append("%").toString(), (i2 + j1) - 50 - fontRenderer.getStringWidth(s1), k2 + j1 / 2 + k3 * 8 + 20,
					profilerresult2.func_40700_a());
			fontRenderer.drawStringWithShadow(s1 = (new StringBuilder()).append(decimalformat.format(profilerresult2.globalPercentage)).append("%").toString(), (i2 + j1) - fontRenderer.getStringWidth(s1), k2 + j1 / 2 + k3 * 8 + 20,
					profilerresult2.func_40700_a());
		}
	...
	public void runTick() {
		...
		if(thePlayer != null) {
			net.minecraft.world.chunk.IChunkProvider ichunkprovider = theWorld.getIChunkProvider();
		...
		if(currentScreen == null || currentScreen.allowUserInput) {
					...
					if(Keyboard.getEventKey() == 87) {
						...
						if(currentScreen != null) {
							...
							if(Keyboard.getEventKey() == Keyboard.KEY_SPACE) {
								// Check if the player can use the Elytra
								if(thePlayer.canUseElytra && !thePlayer.abilities.isFlying) {
									if(thePlayer.onGround) {
										if(!thePlayer.isUsingElytra() && !thePlayer.elytraToggled) {
											thePlayer.elytraToggled = true;
										}else if(thePlayer.elytraToggled) {
											thePlayer.elytraToggled = false;
										}
									}else {
										thePlayer.setUsingElytra(!thePlayer.isUsingElytra());
									}
								}else {
									// Disable Elytra usage if conditions are not met
									thePlayer.setUsingElytra(false);
									thePlayer.elytraToggled = false;
							...
							if(Keyboard.getEventKey() == 61) {
								if(!gameSettings.showDebugInfoLess && !gameSettings.showDebugInfoMore) {
									gameSettings.showDebugInfoLess = true;
								}else if(gameSettings.showDebugInfoLess && !gameSettings.showDebugInfoMore) {
									gameSettings.showDebugInfoLess = false;
									gameSettings.showDebugInfoMore = true;
								}else {
									gameSettings.showDebugInfoMore = false;
								}
							}
			...
			for(; gameSettings.keyBindCreateInventory.isPressed() && playerController.isInCreativeMode(); displayGuiScreen(new GuiContainerCreative(thePlayer))) {
			}
			for(; gameSettings.keyBindDrop.isPressed(); thePlayer.dropCurrentItem()) {
			}
			for(; gameSettings.keyBindChat.isPressed(); displayGuiScreen(new GuiChat())) {
			}
		...
		if(world != null) {
			...
			if(!isMultiplayerWorld()) {
				if(entityplayer == null) {
					thePlayer = (EntityPlayerSP) world.func_4085_a(net.minecraft.entity.EntityPlayerSP.class);
				}
			...
			net.minecraft.world.chunk.IChunkProvider ichunkprovider = world.getIChunkProvider();
			if(ichunkprovider instanceof ChunkProviderLoadOrGenerate) {
				ChunkProviderLoadOrGenerate chunkproviderloadorgenerate = (ChunkProviderLoadOrGenerate) ichunkprovider;
	...
	public static boolean isDebugInfoEnabled() {
		return theMinecraft != null && theMinecraft.gameSettings.showDebugInfoMore;
	}
