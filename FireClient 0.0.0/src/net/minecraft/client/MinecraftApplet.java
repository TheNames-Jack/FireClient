...
import net.minecraft.util.CanvasMinecraftApplet;
...
public class MinecraftApplet extends Applet {
	...
	public void init() {
		...
		if(getParameter("username") != null && getParameter("sessionid") != null) {
			...
			System.out.println((new StringBuilder()).append("Setting user: ").append(mc.session.username).append(", ").append(mc.session.token).toString());
